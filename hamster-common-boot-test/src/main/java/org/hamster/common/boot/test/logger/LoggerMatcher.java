...
public interface LoggerMatcher<T> {
     ...
     *
     * @param keyword the keyword to search
     * @param index optional, the logging history position, default to be -1 for scanning all loggers
     * @throws AssertionError if none of the appended loggers matches
     */
     ...
     * @param keyword the keyword to search
     * @param index optional, the logging history position, default to be -1 for scanning all loggers
     * @param level optional, expected logging level, default to be null for all logging levels
     * @throws AssertionError if none of the appended loggers matches
     */
     ...
     * @param index optional, the logging history position, default to be -1 for scanning all loggers
     * @param level optional, expected logging level, default to be null for all logging levels
     * @param negative optional, the log must not be printed, default to be false
     * @throws AssertionError if none of the appended loggers matches
     */
